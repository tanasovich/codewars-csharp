...
public class Tests
{
    ...
    [Test]
    public void LikesWitMoreThanThreeNamesReturnsCorrectLikes()
    {
        //Arrange
        string[] names = new string[] { "Valentine", "Vlad", "Joaquín", "Antonio" };
        string expected = "Valentine, Vlad and 2 others like this";
